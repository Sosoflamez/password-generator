        ...
        <div ref={optionsRef} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            {OPTIONS_CONFIG.map(({ key, label, example }) => (
                ...
                >
                    ...
                    />
                    <div>
                        <div style={{ fontSize: "13px", fontWeight: 600, color: (options as unknown as Record<string, boolean>)[key] ? "#00ff41" : "rgba(255,255,255,0.75)" }}>{label}</div>
